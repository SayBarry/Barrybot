...
$videoURLStart = "https://t.me/Barry_op/10";


if (preg_match('/^(\/start|\.start|!start)/', $text)) {
    if (in_array($userId, $freeusers)) {
        $caption = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 <code>@$username</code> 𝘁𝗼 BARRY OP💖
        ...
        'inline_keyboard' => [
            [
                             ['text' => '𝙂𝘼𝙏𝙀𝙒𝘼𝙔𝙎', 'callback_data' => 'gates'],
                                 ...
                                 [
                                 ['text' => '@Barey_op', 'callback_data' => 'channel'],
                             ],
        ]
    ]);

    $caption = "Welcome To Barry op. Buy The Plan First.  /price 
...

{
 ...
 $caption=" Pricing Baery op Checker📍
━━━━━━━━━━━━━━━━━━
⑄ 𝙎𝙐𝘽𝙎𝘾𝙍𝙄𝙋𝙏𝙄𝙊𝙉 𝙈𝙀𝙉𝙐 ⑄
━━━━━━━━━━━━━━━━━━
× 1 𝘞𝘌𝘌𝘒  - 3$
